  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-blue-900 to-purple-900 flex items-center justify-center py-8">
      ...
      >
        ...
        {/* Reference Selection */}
        <div className="mb-4">
          <label className="block mb-1 text-white">Reference Student</label>
          <select
            name="referenceId"
        ...
        {form.referenceId && (
          <div className="mb-4">
            <label className="block mb-1 text-white">Discount for Reference Student</label>
            <select
              name="discountId"
            ...
            {form.discountId && (
              <div className="mt-2">
                <label className="block mb-1 text-sm text-gray-300">Selected Discount:</label>
                <div className="inline-flex items-center px-2 py-1 rounded-full text-xs font-medium bg-blue-500/20 text-blue-300 border border-blue-500/30">
                  ...
                  <button
                    ...
                    className="ml-1 inline-flex items-center justify-center w-4 h-4 rounded-full text-blue-400 hover:bg-blue-500/20"
                  >
                    ×
                  </button>
                </div>
        ...
        {form.type === "old" && (
          <>
            <div className="mb-4">
              <label className="block mb-1 text-white">Current Month Rent Due</label>
              <input
                type="number"
            ...
            <div className="mb-4">
              <label className="block mb-1 text-white">Current Month External Due</label>
              <input
                type="number"
            ...
            <div className="mb-4">
              <label className="block mb-1 text-white">Current Month Advance Due</label>
              <input
                type="number"
            ...
            <div className="mb-4">
              <label className="block mb-1 text-white">Previous Due</label>
              <input
                type="number"
                name="previousDue"
